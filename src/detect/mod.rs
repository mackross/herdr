...
mod tests {
    ...
    fn identify_known_agents() {
        ...
        assert_eq!(identify_agent("weaver"), Some(Agent::Weaver));
    }
    ...
    fn parse_known_agent_labels() {
        ...
        assert_eq!(parse_agent_label("weaver"), Some(Agent::Weaver));
    }
    ...
    #[test]
    fn weaver_is_hook_authority_without_screen_manifest() {
        assert!(full_lifecycle_hook_authority("custom:weaver", "weaver"));
        assert!(!Agent::SCREEN_MANIFEST_AGENTS.contains(&Agent::Weaver));
    }
